...
// The resolved dictionary arrives as a prop from the server page — importing
// getDict here would pull all five locale dictionaries into the client bundle.
...
export default function InspireBrowse({ cards, lang = "en", initialContinent = "", dict = {} }) {
