...
const TIPS = [
  ...
  ["Dettifoss has two access roads.", "Most people take the worse one because a map told them it was shorter. The guide names the right bank."],
  ["Kitchens close early outside Reykjavík.", "Early enough to catch anyone planning dinner after a long driving day – a shut kitchen is how people end up eating fuel-station hot dogs twice. The guide's restaurant picks carry the closing times."],
