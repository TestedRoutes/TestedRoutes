...
const ALT = {
  ...
  "story-samoa-upolu-5-days": {
    "1. cover.jpg": { alt: "Cover of the Samoa five-day Upolu guide" },
    "2. snapshot.jpg": { alt: "Route snapshot page: why this trip, at a glance, and the photo spread" },
    "3.mp4": { alt: "A tall waterfall dropping into its jungle gorge, filmed on the route" },
    "4.jpg": { alt: "A thatched beach fale on the white sand, palms overhead" },
    "5.mp4": { alt: "A wild green turtle grazing the seagrass in the shallows at Savaia" },
    "6.mp4": { alt: "A tiny palm islet just offshore in soft light" },
    "7.mp4": { alt: "A giant clam on the reef at the Savaia sanctuary, filmed while snorkelling" },
    "8.mp4": { alt: "To-Sua Ocean Trench from the rim, the ladder down to the green pool" },
    "9.jpg": { alt: "The white spire of the Apia Samoa Temple above red flower beds" },
