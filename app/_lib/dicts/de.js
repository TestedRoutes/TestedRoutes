...
const de = {
  ...
  inspireList: {
    ...
    journeys: [
      ...
      { eyebrow: "Westafrika", title: "Africa Rally", blurb: "Mehrjährige Overland-Fahrt" },
  ...
  guideList: {
    ...
    showing: "{shown} von {total} Guides",
    showGuides: "{n} Guides anzeigen",
    showGuide: "1 Guide anzeigen",
    selectedCount: "{n} ausgewählt",
    noOptions: "Hier bleibt nichts zur Auswahl",
    trust: [
