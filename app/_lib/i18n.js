...
const de = {
  ...
  story: {
    ...
    planningBody:
      "Der komplette Guide deckt Genehmigungen, Ausrüstung, Logistik und Kosten ab – alles, was du für die eigene Planung brauchst.",
    readFullGuide: "Zum kompletten Guide →",
...
const es = {
  ...
  story: {
    ...
    planningBody:
      "La guía completa cubre permisos, equipo, logística y costes – todo lo que necesitas para planificarlo por tu cuenta.",
...
const fr = {
  ...
  story: {
    ...
    planningBody:
      "Le guide complet couvre permis, équipement, logistique et budget – tout ce qu'il faut pour le planifier vous-même.",
...
const lt = {
  ...
  story: {
    ...
    planningBody:
      "Pilname gide – leidimai, įranga, logistika ir išlaidos: viskas, ko reikia susiplanuoti patiems.",
    readFullGuide: "Skaityti pilną gidą →",
