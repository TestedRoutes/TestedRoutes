...
import zoueratRailsDusk from "../../../../content/countries/mauritania/destination/generated/web/zouerat-rails-dusk.jpg";
...
const CAROUSEL = [
  ...
  { image: donkeyCartFishBeach, alt: "A donkey cart between beached wooden pirogues on the fish beach", caption: "The fish beach at work" },
  { image: cityTrafficOldMercedes, alt: "Battered old Mercedes sedans in slow city traffic", caption: "The national car" },
...
const TIPS = [
  ...
  ["The train is real, and so is the ore.", "The iron-ore train keeps no timetable you can plan around, there is no carriage, and the only warm thing aboard on a desert night is the ore itself. It is the best thing we did in the country and it rewards exactly the preparation it demands – ride it on tested information, not on a forum thread."],
