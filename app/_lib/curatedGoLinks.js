// Curated /go/ short links, in their own module so both the redirector
// (app/go/[slug]/route.js) and the weekly link monitor
// (app/api/cron/link-monitor) can read one list. A Next route file may
// only export handler names, which is why the map cannot live in the
// route and be shared from there.
/**
