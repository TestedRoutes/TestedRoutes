...
const ALT = {
  ...
  "story-gruben-to-grimentz": {
    ...
    "3. clip.mp4": { alt: "Climbing the loose-rock slope to the Meidpass, filmed on the route" },
    "4. clip.mp4": { alt: "Looking over the Val d'Anniviers from the balcony trail, filmed on the route" },
    "5.jpg": { alt: "Hiker above the Val d'Anniviers with 4,000-metre peaks across the valley" },
    "6. clip.mp4": { alt: "The flag viewpoint above the valley on Day 2, filmed on the route" },
    "7.jpg": { alt: "The high valley opening towards the Zinal 4,000ers" },
    "8.jpg": { alt: "The signpost on the Meidpass at 2,790 m" },
    "9.jpg": { alt: "Tipi tents in the meadow by the Hotel Weisshorn" },
    "10.jpg": { alt: "Selfie below the rock towers on the Meidpass crossing" },
    "11.jpg": { alt: "Evening alpenglow over Gruben in the Turtmanntal" },
    "12.jpg": { alt: "Carved wooden figures along the forest trail above St-Luc" },
    "13.jpg": { alt: "The white Hotel Weisshorn at 2,337 m, the overnight stop" },
    "14.jpg": { alt: "Selfie on the balcony trail towards Grimentz on Day 2" },
    "15.jpg": { alt: "Blueberry pie at the Hotel Weisshorn" },
  },
