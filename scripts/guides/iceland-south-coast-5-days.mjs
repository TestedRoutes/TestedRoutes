/**
 * iceland-south-coast-5-days: content for the Sanity story doc.
 *
...
export default {
  docId: "story-iceland-south-coast-5-days",

  // metaDescription is 139 characters, under the 145 floor - it has room for
  // roughly one more clause.
  //
  // No Content Plan row to sync from: this guide is not flagged Published in
  // v54, and the copy below currently appears in the plan's Iceland Ring Road
  // row instead of its own. Sort the plan out before re-cutting this.
  ...
  assets: {
    ...
    // Originally: C:\Users\pauli\AppData\Local\Temp\claude\C--Users-pauli-Desktop-TestedRoutes---Website\b274bb1c-25d2-41a3-a621-b4838b23f3fb\scratchpad\guide-assets-iceland-5d
    dir: null,
    hero: { file: "hero.jpg", alt: "Basalt columns at Reynisfjara with the Reynisdrangar sea stacks rising from the black sand beyond" },
    gallery: [
      { file: "g1.jpg", key: "g1jpg", alt: "A blue-white iceberg glowing in sunlight on the glacier lagoon" },
      { file: "g2.jpg", key: "g2jpg", alt: "A Reykjavík shopping street with painted shopfronts and benches" },
      { file: "g3.jpg", key: "g3jpg", alt: "Hallgrímskirkja seen head-on from the plaza, its stepped concrete façade filling the frame" },
      { file: "g4.jpg", key: "g4jpg", alt: "Skógafoss pouring over its lip, walkers at the base for scale" },
      { file: "g5.jpg", key: "g5jpg", alt: "Icebergs drifting across Jökulsárlón toward the sea" },
    ],
    trackLine: "tracklines/iceland-south-coast-5-days.json",
    pdf: {
      path: "content/countries/iceland/guides/iceland-south-coast-5-days/TestedRoutes_Iceland_Guide_5_Days_South_Coast.pdf",
  ...
  doc: {
    ...
    body: [
      paragraph("b1", "Most south-coast itineraries are three days that sprint to the glacier lagoon and back, or a full Ring Road that spends half its week driving the north. This one takes five days on the stretch everyone actually comes for, and folds the Golden Circle into the drive home - where it costs nothing."),
      paragraph("b2", "Every day is timed to the hour: arrival, how long the stop is worth, and the leave-by that keeps the rest of the day intact. Three hotels across five nights - Reykjavík and Vík twice each, one night at the glacier - and about 1,300 km of driving that never needs a 4WD or an F-road."),
      paragraph("b3", "It is an honest plan rather than a comfortable one. Reynisfjara's sneaker waves are named as the one genuine danger on the route, the Blue Lagoon comes with an eruption plan, and every long day says what to cut when you fall behind."),
    ],
