...
const en = {
  ...
  inspireList: {
    ...
    searchButton: "Search",
    heading: "Journeys I've actually done",
    story: "story",
    stories: "stories",
  ...
  guideList: {
    ...
    filterSeason: "Season",
    trust: [
      { title: "Walked in person", body: "No guide goes live until I've done it." },
      { title: "Built for printing", body: "One PDF, offline-ready, no app required." },
      { title: "Real numbers", body: "Costs, huts, permits and transfer times." },
    ],
    testedBy: "Tested by",
...
const de = {
  ...
  inspireList: {
    ...
    searchPlaceholder: "Reisen durchsuchen…",
    searchButton: "Suchen",
    heading: "Reisen, die ich wirklich gemacht habe",
    story: "Geschichte",
    stories: "Geschichten",
    ...
    extremeLabels: [
      "Stierlauf in Pamplona – Spanien",
      "Haitauchen – Fidschi",
      "Volcano Boarding – Nicaragua",
      "Fallschirmspringen & Paragliding",
      "Eisklettern & Gletschertouren",
      "Mit dem Erzzug durch Mauretanien",
      "Gipfel über 6.000 m",
      "Abgelegene Grenzübergänge – Westafrika",
    ],
  ...
  guideList: {
    ...
    filterSeason: "Saison",
    trust: [
      { title: "Selbst gelaufen", body: "Kein Guide geht live, bevor ich ihn selbst gemacht habe." },
      { title: "Zum Ausdrucken gemacht", body: "Ein PDF, offline nutzbar, keine App nötig." },
      { title: "Echte Zahlen", body: "Kosten, Hütten, Genehmigungen und Transferzeiten." },
    ],
...
const es = {
  ...
  inspireList: {
    ...
    searchButton: "Buscar",
    heading: "Viajes que realmente he hecho",
    story: "historia",
    stories: "historias",
    ...
    extremeLabels: [
      ...
      "Cumbres por encima de 6.000 m",
      "Cruces de frontera remotos – África Occidental",
    ],
  ...
  guideList: {
    ...
    trust: [
      { title: "Recorrido en persona", body: "Ninguna guía se publica hasta que la he hecho yo mismo." },
      { title: "Pensada para imprimir", body: "Un PDF, funciona sin conexión, sin apps." },
      { title: "Números reales", body: "Costes, refugios, permisos y tiempos de traslado." },
    ],
...
const fr = {
  ...
  inspireList: {
    ...
    heading: "Des voyages que j'ai vraiment faits",
    story: "histoire",
    stories: "histoires",
    ...
    extremeLabels: [
      ...
      "Volcano boarding – Nicaragua",
      "Parachutisme et parapente",
      "Cascade de glace et glaciers",
      "Le train du minerai de fer – Mauritanie",
      "Sommets à plus de 6 000 m",
      "Postes-frontières isolés – Afrique de l'Ouest",
    ],
  ...
  guideList: {
    ...
    filterSeason: "Saison",
    trust: [
      { title: "Parcouru en personne", body: "Aucun guide n'est publié avant que je l'aie fait moi-même." },
      { title: "Conçu pour l'impression", body: "Un PDF, utilisable hors ligne, sans application." },
      { title: "De vrais chiffres", body: "Coûts, refuges, permis et temps de transfert." },
    ],
    testedBy: "Testé par",
...
const lt = {
  ...
  inspireList: {
    ...
    heading: "Kelionės, kuriose tikrai buvau",
    story: "istorija",
    stories: "istorijos",
    ...
    extremeLabels: [
      ...
      "Šuoliai parašiutu ir parasparniai",
      "Kopimas ledu ir ledynų žygiai",
      "Geležies rūdos traukinys – Mauritanija",
      "Viršukalnės virš 6 000 m",
      "Atokūs sienų kirtimai – Vakarų Afrika",
    ],
  ...
  guideList: {
    ...
    trust: [
      { title: "Nueita savomis kojomis", body: "Gidas skelbiamas tik tada, kai pats jį įveikiu." },
      { title: "Pritaikyta spausdinti", body: "Vienas PDF, veikia be interneto, nereikia programėlės." },
      { title: "Tikri skaičiai", body: "Kainos, nakvynės, leidimai ir persėdimų laikai." },
    ],
    testedBy: "Išbandė",
