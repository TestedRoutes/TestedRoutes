...
const es = {
  ...
  inspireList: {
    ...
    journeys: [
      ...
      { eyebrow: "África Occidental", title: "Africa Rally", blurb: "Ruta overland de varios años" },
  ...
  guideList: {
    ...
    showing: "Mostrando {shown} de {total} guías",
    showGuides: "Ver {n} guías",
    showGuide: "Ver 1 guía",
    selectedCount: "{n} seleccionados",
    noOptions: "No queda nada que elegir aquí",
    trust: [
