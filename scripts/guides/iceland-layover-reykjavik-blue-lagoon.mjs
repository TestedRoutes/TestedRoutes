/**
 * iceland-layover-reykjavik-blue-lagoon: content for the Sanity story doc.
 *
...
export default {
  docId: "story-iceland-layover-reykjavik-blue-lagoon",
  ...
  assets: {
    ...
    // Originally: C:\Users\pauli\AppData\Local\Temp\claude\C--Users-pauli-Desktop-TestedRoutes---Website\40a48b0a-94b1-4a73-a99d-623940f36215\scratchpad\guide-assets-iceland-layover-1d
    dir: null,
    hero: { file: "hero.jpg", alt: "The Blue Lagoon's milky-blue water full of bathers, steam drifting toward the lava ridge" },
    gallery: [
      { file: "g1.jpg", key: "g1jpg", alt: "The boardwalk into the Blue Lagoon, a lifeguard's yellow vest over the steam" },
      { file: "g2.jpg", key: "g2jpg", alt: "Thumbs up in a white silica mask, mid-soak in the lagoon" },
      { file: "g3.jpg", key: "g3jpg", alt: "Seabird cliffs above the churning surf at the Reykjanes lighthouse corner" },
      { file: "g4.jpg", key: "g4jpg", alt: "Hallgrimskirkja head-on from the plaza, wet paving in the evening light" },
      { file: "g5.jpg", key: "g5jpg", alt: "The painted shopping street in central Reykjavik, benches and gable ends" },
      { file: "g6.jpg", key: "g6jpg", alt: "Hallgrimskirkja's concrete columns sweeping up to the spire" },
    ],
    trackLine: "tracklines/iceland-layover-reykjavik-blue-lagoon.json",
    pdf: {
      path: "content/countries/iceland/guides/iceland-layover-reykjavik-blue-lagoon/TestedRoutes_Iceland_Guide_1_Day_Reykjavik_Blue_Lagoon.pdf",
  ...
  doc: {
    ...
    body: [
      paragraph("b1", "Our own version of this day ran backwards. We landed in the evening, too late for the peninsula, so the first hours were Reykjavik on foot - the waterfront, the painted street climbing to the church, and a city that stays light long past ten in late May. The loop waited for morning."),
      paragraph("b2", "The next day was the guide's day compressed: the lagoon not long after opening - silica masks, steam rolling off the water, a drink at the in-water bar - then the lighthouse corner with Gunnuhver roaring behind its ropes and seabirds stacked on the cliffs, and black sand between the stops. By mid-afternoon we were at the car return, smelling faintly of sulphur, with the whole country ticked in a day."),
      paragraph("b3", "That reversed run is exactly why this guide is built on an anchor you can shift. Flights hit Keflavik at every hour, so the plan is written 10:00 to 10:00 with rules for moving it - land at dawn, land at midnight, fly out early - instead of pretending everyone arrives at the same time. The order of the day changes; the day itself holds."),
    ],
