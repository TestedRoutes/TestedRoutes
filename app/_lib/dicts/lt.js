...
const lt = {
  ...
  inspireList: {
    ...
    journeys: [
      ...
      { eyebrow: "Vakarų Afrika", title: "Africa Rally", blurb: "Kelerių metų kelionė sausuma" },
  ...
  guideList: {
    ...
    countriesWord: "šalys",
    showing: "Rodoma {shown} iš {total} gidų",
    showGuides: "Rodyti {n} gidus",
    showGuide: "Rodyti 1 gidą",
    selectedCount: "Pasirinkta: {n}",
    noOptions: "Čia nebėra ką pasirinkti",
    trust: [
