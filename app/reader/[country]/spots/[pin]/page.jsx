 ...
 * each route, a small map, what is nearby, Directions, and the affiliate
 * slot — the "check what is nearby" the founder asked for lives here.
 */
export default async function ReaderSpot({ params }) {
  ...
  if (!place) notFound();
  trackReaderView(country, "spot", { pin });
  ...
  return (
    <>
      <Link href={readerPaths.spots(country)} className="font-sans text-[11px] font-bold uppercase tracking-[0.12em] text-slate-600 hover:text-brand-terracotta">← Spots</Link>
